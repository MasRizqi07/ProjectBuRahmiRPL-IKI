...
import { TicketTier } from '@/lib/types/concert'
...
export function TicketTierCard({ tier, concertId }: TicketTierCardProps) {
  ...
  const percent = tier.capacity > 0 ? (tier.sold / tier.capacity) * 100 : 100
    ...
    >
      ...
      <div className="mt-auto">
        <Link
          ...
          className={!isAvailable ? 'pointer-events-none block' : 'block'}
        >
          <Button
            className={cn(
